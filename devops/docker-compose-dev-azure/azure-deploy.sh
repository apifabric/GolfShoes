...
resourcename="golfshoes"  # lower case, only
resourcegroup="golfshoes_rg"
...
# git clone https://github.com/apilogicserver/golfshoes.git
# cd golfshoes
...
az group create --name golfshoes_rg --location "westus"
az appservice plan create --name myAppServicePlan --resource-group golfshoes_rg --sku S1 --is-linux
az container create --resource-group golfshoes_rg --name golfshoes --image apilogicserver/golfshoes:latest --dns-name-label golfshoes --ports 5656 --environment-variables 'VERBOSE'='True'  'APILOGICPROJECT_CLIENT_URI'='//golfshoes.westus.azurecontainer.io:5656'
